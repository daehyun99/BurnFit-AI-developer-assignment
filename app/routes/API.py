...
def api(user_input: str):
    ...
    prompt =f"""
            ...
            [3] 사용자의 운동 경력은 {LV}입니다. 이에 맞게 답변에 사용할 운동 용어를 조절하여, 사용자가 이해하기 쉬운 수준에서 답변해주세요.
            [4] 예를 들어, 초급자에게는 '1RM' -> '들 수 있는 최대 무게'처럼 쉽게 풀어 설명해주세요.
            [5] 사용자들에게 동기부여해주세요. 그러면 사람들은 당신을 더욱 신뢰하고, 연봉이 상승할지도 몰라요!
            """
